...
export default function OptionsServices() {
    return (
        <div className='body-options'>
            <ul>
                <li>
                    <Link to="/create_service" className='op'>
                        <div className='icon'>
                ...
                <li>
                    <Link to="/acumulated_services" className='op'>
                        <div className='icon'>
                ...
                <li>
                    <Link to="/service_requests" className='op'>
                        <div className='icon'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-send-exclamation" viewBox="0 0 16 16">
